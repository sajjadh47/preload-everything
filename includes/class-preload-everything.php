<?php
/**
 * This file contains the definition of the Preload_Everything class, which
...
class Preload_Everything {
	 ...
	 * @since     2.0.0
	 * @access    protected
	 * @var       Preload_Everything_Loader $loader Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		$this->version     = defined( 'PRELOAD_EVERYTHING_PLUGIN_VERSION' ) ? PRELOAD_EVERYTHING_PLUGIN_VERSION : '1.0.0';
		$this->plugin_name = 'preload-everything';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once PRELOAD_EVERYTHING_PLUGIN_PATH . 'includes/class-preload-everything-loader.php';
		 ...
		 */
		require_once PRELOAD_EVERYTHING_PLUGIN_PATH . 'admin/class-preload-everything-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once PRELOAD_EVERYTHING_PLUGIN_PATH . 'public/class-preload-everything-public.php';

		$this->loader = new Preload_Everything_Loader();
	}

	/**
	 * Define the locale for this plugin for internationalization.
	 *
	 * Uses the Preload_Everything_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since     2.0.0
	 * @access    private
	...
	private function set_locale() {
		$plugin_i18n = new Preload_Everything_i18n();
	...
	private function define_admin_hooks() {
		$plugin_admin = new Preload_Everything_Admin( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'plugin_action_links_' . PRELOAD_EVERYTHING_PLUGIN_BASENAME, $plugin_admin, 'add_plugin_action_links' );
	...
	private function define_public_hooks() {
		$plugin_public = new Preload_Everything_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 * @since     2.0.0
	 * @access    public
	 * @return    Preload_Everything_Loader Orchestrates the hooks of the plugin.
	 */
